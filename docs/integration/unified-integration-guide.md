...
**Статус: целевой контракт подготовлен, подтверждение команд ожидается.
V2 ещё не реализован и не развёрнут.** Работающий v1 нельзя считать реализацией
...
**Единый кандидат для подтверждения командами и реализации.** Дата: 2026-09-26.
Решения и форматы в этой версии зафиксированы со стороны AI. Подтверждение Backend,
Frontend, Admin и Audio ещё не получено. V2 **не реализован и не развёрнут**;
