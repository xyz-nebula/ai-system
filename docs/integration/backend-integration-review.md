...
**Исторический срез.** Backend dev позднее обновился до `412fb983…` и добавил
миграции. Актуальные изменения и матрица требований:
[повторный аудит](project-requirements-and-fields-audit.md). Вывод «миграций нет»
ниже относится только к указанному старому commit, не к текущему dev.
